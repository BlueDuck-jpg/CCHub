...
local ugh = 0
repeat wait(0.001) ugh = ugh + 0.001 until suc

if suc then
    createNotification("SUCCESS!", "Successfully bypassed anti cheat! Time took: " .. ugh, 5)
else
    createNotification("WARNING!", "Can't bypass anti cheat: " .. err, 5)
end

Cheats:NewButton("Get All Items", "Gets every item in Tower Of Hell", function()
...
Cheats:NewToggle("Infinite Jump", "Enables infinite jump", function(t)
    infjumpenabled = t
end)

Cheats:NewToggle("God Mode", "Enables god mode", function(t)
    godmodeenabled = t
end)
...
Cheats:NewSlider("Jump Power", "JumpPower", 100, 0, function(t)
